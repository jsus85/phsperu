      ...
      <!-- /.row -->
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('contenidos/add');?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="categoria">Categoria</label>
                     <select id="categoria" name="categoria" required="required" class="form-control">
                                      ...
                                      <option <?php if(set_value('categoria')==$value->id){echo "selected";}?> value="<?php echo $value->id;?>"><?php echo $value->nombres;?></option>
                                      <?php }?>                                  
                                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required id="titulo" name="titulo" value="<?php echo set_value('titulo');?>" placeholder="Ingrese el titulo del contenido">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Resumen</label>
                  <textarea  class="form-control" id="resumen" name="resumen" required /><?php echo set_value('resumen');?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea id="descripcion" name="descripcion" rows="10" cols="80"><?php echo set_value('descripcion');?></textarea>
                </div>
